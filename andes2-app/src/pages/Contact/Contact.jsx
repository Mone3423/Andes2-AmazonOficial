              ...
              <Card className="border-0 shadow rounded-3 mb-4">
                <Card.Body className="text-center">
                  ...
                  <p className="mb-3 body-text">
                    Do you have questions? Call or write to us
                  </p>
            ...
            <Col lg="4" md="12" className="mb-4 mb-lg-0">
              <Card className="border-0 shadow rounded-3 mb-4">
                <Card.Body className="text-center">
                  ...
                  <p className="mb-3 body-text">
                    Follow us on social media to learn about our work
                  </p>
                  <div className="d-block justify-content-center">
                    <ListGroup horizontal className="justify-content-center">
                      <ListGroup.Item className="border-0">
                        <a href="https://www.facebook.com/Andes2Amazon" target="_blank" rel="noopener noreferrer">
                      ...
                      <ListGroup.Item className="border-0">
                        <a href="https://www.youtube.com/channel/UCIIeRPczn1QVsA5ByspArbQ" target="_blank" rel="noopener noreferrer">
